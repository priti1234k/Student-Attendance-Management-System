...
<div class="" id="um">
 ...
 <div class="row my-5">
                    <h3 class="fs-4 mb-3">Year Details</h3>
                    <div class=" table bg-white rounded shadow-sm  table-hover">
					<div class="col">
                     
                        <a href="yearcreate.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add New Year</a>
                    </div>
				   <?php

require "config.php";
$sql="select * from year_master where status='active'";
...
while($row=mysqli_fetch_assoc($query))
{
	echo "<tr>";
                                        ...
                                        echo "<td>";
											...
											echo '<a href="yearupdate.php?id='. $row['Y_id'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fas fa-pen"></span></a>';
                                            echo " ";
											echo '<a href="yeardelete.php?id='. $row['Y_id'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
}
 echo "</tbody>";                            
