...
<div class="" id="um">
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    <h3 class="fs-4 mb-3">Course Details</h3>
                    <div class=" table bg-white rounded shadow-sm  table-hover">
					<div class="col">
                     
                        <a href="coursecreate.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add New Course</a>
                    </div>
				   <?php

require "config.php";
$sql="select DeptName ,Course_id,coursename,yearorsem,year from dept_master d, course_master c where d.D_id=c.D_id";;
...
while($row=mysqli_fetch_assoc($query))
{
	...
	echo "<tr>";
                                        ...
                                        echo "<td>";
											...
											echo '<a href="courseupdate.php?id='. $row['Course_id'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fas fa-pen"></span></a>';
                                            echo " ";
											echo '<a href="coursedelete.php?id='. $row['Course_id'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
}
 echo "</tbody>";                            
