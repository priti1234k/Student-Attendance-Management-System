...
<div class="" id="um">
 ...
 <div class="row my-5">
                    <h3 class="fs-4 mb-3">Subject Details</h3>
                    <div class=" table bg-white rounded shadow-sm  table-hover">
					<div class="col">
                     
                        <a href="Subjectcreate.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add New Subject</a>
                    </div>
				   <?php

require "config.php";
$sql="select DeptName ,coursename,subject_id,subjectname from dept_master d, course_master c ,subject_master s where d.D_id=c.D_id AND c.Course_id=s.Course_id";;
...
while($row=mysqli_fetch_assoc($query))
{
	echo "<tr>";
                                        ...
                                        echo "<td>";
											...
											echo '<a href="subjectupdate.php?id='. $row['subject_id'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fas fa-pen"></span></a>';
                                            echo " ";
											echo '<a href="subjectdelete.php?id='. $row['subject_id'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
}
 echo "</tbody>";                            
