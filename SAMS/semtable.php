...
<div class="" id="um">
            <div class="container-fluid px-4">
                          ...
                          <div class="row my-5">
                    <h3 class="fs-4 mb-3">Semester Details</h3>
                    <div class=" table bg-white rounded shadow-sm  table-hover">
					<div class="col">
                     
                        <a href="semcreate.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add New Semester</a>
                    </div>
				   <?php

require "config.php";
$sql="select * from sem_master where status='active'";
...
while($row=mysqli_fetch_assoc($query))
{
	echo "<tr>";
                                        ...
                                        echo "<td>";
											...
											echo '<a href="semupdate.php?id='. $row['S_id'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fas fa-pen"></span></a>';
                                            echo " ";
											echo '<a href="semdelete.php?id='. $row['S_id'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
}
 echo "</tbody>";                            
