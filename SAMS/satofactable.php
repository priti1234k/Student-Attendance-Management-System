...
<div class="" id="um">
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    <h3 class="fs-4 mb-3"> Details</h3>
                    <div class=" table bg-white rounded shadow-sm  table-hover">
					<div class="col">
                     
                        <a href="satofaccreate.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Assign Subject to Faculty</a>
                    </div>
				   <?php

require "config.php";
$sql="select stof_id,facultyname,DeptName ,coursename,subjectname from dept_master d, course_master c,faculty_master f,subject_master s,tblallotstof saf where d.D_id=saf.D_id AND c.Course_id=saf.Course_id AND f.Fac_id=saf.Fac_id And s.subject_id=saf.subject_id";;
...
while($row=mysqli_fetch_assoc($query))
{
	...
	echo "<tr>";
                                        ...
                                        echo "<td>";
											...
											echo '<a href="satofacupdate.php?id='. $row['stof_id'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fas fa-pen"></span></a>';
                                            echo " ";
											echo '<a href="satofacdelete.php?id='. $row['stof_id'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
}
 echo "</tbody>";                            
