...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($facname_err) && empty($email_err) && empty($contact_err) && empty($gender_err) && empty($username_err) && empty($password_err)){
        ...
        $sql = "INSERT INTO student_master (studentname , Email , Contact , gender , Username , Password , status) VALUES (? , ? , ? , ? , ? ,?, ?)";
...
.b{
   width:40%;
	...
	<input type="text" name="studname" placeholder="Enter student Name" class="form-control <?php echo (!empty($studname_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $studname; ?>" >
