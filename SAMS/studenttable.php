            ...
            <div class="container-fluid px-4">
			 <div class="row my-5">
					...
					<div class="col">
                        ...
                        <a href="studentcreate.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add New student</a>
                    </div>
				   <?php

require "config.php";
$sql="select * from student_master where status='active'";
...
while($row=mysqli_fetch_assoc($query))
{
	echo "<tr>";
                                        ...
                                        echo "<td>";
											...
											echo '<a href="studentupdate.php?id='. $row['student_id'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fas fa-pen"></span></a>';
                                            echo " ";
											echo '<a href="studentdelete.php?id='. $row['student_id'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
}
 echo "</tbody>";                            
