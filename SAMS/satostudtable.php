            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
					...
					<div class="col">
                        ...
                        <a href="satostudcreate.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Assign subject to student</a>
                    </div>
				   <?php
...
while($row=mysqli_fetch_assoc($query))
{
	...
	echo "<tr>";
                                        ...
                                        echo "<td>";
											...
											echo '<a href="satostudupdate.php?id='. $row['stos_id'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fas fa-pen"></span></a>';
                                            echo " ";
											echo '<a href="satostuddelete.php?id='. $row['stos_id'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
}
 echo "</tbody>";                            
